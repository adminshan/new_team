...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="/articleadd" data-title="导航栏添加" href="javascript:void(0)">导航栏添加</a></li>
                    <li><a data-href="/articlelist" data-title="导航栏展示" href="javascript:void(0)">导航栏展示</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a data-href="/cateadd" data-title="分类添加" href="javascript:;">分类添加</a></li>
                    <li><a data-href="/catelist" data-title="分类列表" href="javascript:;">分类列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    <li><a data-href="/newadd" data-title="新闻添加" href="javascript:;">新闻添加</a></li>
                    <li><a data-href="/newlist" data-title="新闻列表" href="javascript:;">新闻列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
        ...
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    ...
                    <li><a  target="_parent" href="/quit">退出</a></li>
                </ul>
            </dd>
        </dl>
    </div>
